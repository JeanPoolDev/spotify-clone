...
export function Player() {
  ...
  const { refBg, refBar, play, pause, loading, track,
    currentTime, totalTime, previous, next, seekSong, volumen, range } = useContext(SpotifyContext);
    ...
    <div className="h-[10%] bg-black justify-between flex items-center text-white px-4">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex items-center gap-5">
          ...
          <div onClick={seekSong} ref={refBg} className="w-[65vw] max-w-[500px] bg-white rounded-full cursor-pointer">
